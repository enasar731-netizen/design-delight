...
export const HotkeysPanel = () => {
  return (
    <div className="inline-flex w-[140px] flex-col overflow-hidden rounded-[10px] border border-[hsl(var(--hud-panel-border))] bg-[hsl(var(--hud-panel))] font-sans text-foreground shadow-[0_8px_24px_-4px_hsl(220_50%_2%/0.6)]">
      {/* Header */}
